...
from .caching.caching import ActivationCache
...
def sample_k_truncated_seq(
    ...
    if is_k_diff:
        ...
        return sample_dpmpp_2m_sde_truncated_seq(denoiser, x, sigmas, truncation_ts=truncation_ts, disable=False, callback=callback, extra_args=extra_args, cache=cache)
