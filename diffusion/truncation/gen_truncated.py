...
from .sample_truncated import sample_k_truncated, sample_k_truncated_seq, sample_k_perturbations
...
def generate_perturbations(
    ...
    if diff_objective == "v":    
        # k-diffusion denoising process go!
        sampled_seq = sample_k_perturbations(model.model, noise, init_audio, steps, **sampler_kwargs, **conditioning_inputs, **negative_conditioning_tensors, perturbation_t=perturbation_t, n_perturbations=n_perturbations, cfg_scale=cfg_scale, batch_cfg=True, rescale_cfg=True, device=device)
